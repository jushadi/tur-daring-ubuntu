...
function MoviePlayerSystem($parent){
	...
	this.addVideo = function(){
		var videoObject = '<object width="'+$('#movieplayer .container .video').width()+'" height="'+$('#movieplayer .container .video').height()+'"  id="videoPlayer"><param name="movie" value="http://www.youtube.com/v/4Crve02Gy7s?version=3&amp;hl=en_US"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/4Crve02Gy7s?version=3&amp;hl=en_US" type="application/x-shockwave-flash" width="'+$('#movieplayer .container .video').width()+'" height="'+$('#movieplayer .container .video').height()+'"  name="videoPlayer" allowscriptaccess="always" allowfullscreen="true"></embed></object>'; 
